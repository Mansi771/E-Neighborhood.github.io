...
////here to __ For displaying login approval list with similar area for adminand seller//////////////////
                                ...
                                $qry="select * from registration where isSeller='no' AND user_email_status='verified'";
//////////////////////////// //here//////////////////////////////////////
                                ...
                                <tbody>
                                    <tr class="gradeA odd" role="row">
                                        ...
                                        <td><a href="view_profile_Buyer_ma.php?id=<?php echo $row['us_id'];?>  &email=<?php echo $row['e_mail']; ?>"><?php echo $row['uname']; ?></a></td>
                                        <td><?php echo $row['r_area']; ?></td>
                                        <td><?php echo $row['e_mail']; ?></td>
                                        <td><?php echo $row['register_date']; ?></td>
                                        <td><?php echo $row['active']; ?></td>
                                         
                                     <td><a href="view_buyer_ma.php?up_id=<?php echo $row['us_id']; ?>" class="btn btn-primary btn-circle">&nbsp Activate  &nbsp</a><br><br></a>

                                   <a href="view_buyer_ma.php?del_id=<?php echo $row['us_id']; ?>" class="btn btn-danger btn-circle">Deactivate</a></td>
                                    </tr>
...
if(isset($_REQUEST['del_id'])){
    ...
    $res= mysqli_query($con,$qry);
     $row=mysqli_fetch_array($res);
        ...
        $mail_body = "
        <p>Hi ".$row['uname'].",</p>
            <p>Your Buyer account has been deactivated by Master admin.</p>
        ...
        <p>Please Open this link to login through your verified account- ".$base_url."login.php<p>Best Regards,<br />Team@E-NEIGHBORHOOD</p>         ";
           ...
           $mail1->SetFrom('eneighborhood14@gmail.com', "TEAM@E-NEIGHBORHOOD");
            ...
            if($mail1->Send())
                ...
                ?><script>window.location="view_buyer_ma.php";</script><?php
                    }
            else
            {
...
if(isset($_REQUEST['up_id'])){
    ...
    $res= mysqli_query($con,$qry);
     $row=mysqli_fetch_array($res);
        ...
        $mail_body = "
       <p>Hi ".$row['uname'].",</p>
            <p>Your Buyer account has been activated by Master admin.</p>
        <p>Please Open this link to login through your verified account- ".$base_url."login.php<p>Best Regards,<br />Team@E-NEIGHBORHOOD</p>    ";
            $mail1 = new PHPMailer\PHPMailer\PHPMailer();
            $mail1->IsSMTP();
            $mail1->SMTPDebug  = false;
