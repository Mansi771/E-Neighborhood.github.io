                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="index.html"> <h4>MASTER ADMIN LOGIN</h4></a>
        ...
        function Toggle() { 
            ...
            if (temp.type === "password") { 
                ...
                temp.type = "password"; 
                                ...
                                <a href="maforget_pass.php">Forgot Password?</a>
                            </div>
                        </div>
                        </div>
                    </div>
...
$qry="select * from maadmin where email='$name'";
...
//      if($row['password']==$pass)
       if(password_verify($pass,$row['password']))
       {
            ...
            ?>
    <script>window.location="indexma.php";</script>
             <?php
       }
     else
      {
