...
<!--PAge for viewing 24X7 Hub list and updating and deleting   it from Area Admin side  -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body"><br>
                              <center> <h4 class="card-title">24 X 7 HUB List</h4></center>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline collapsed" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 83px;">Shop Name</th>
...
////here to __ For displaying  list of product added by  seller//////////////////
                                                    ...
                                                    $qry="select * from hub where mail='$user'";
//////////////////////////// //here//////////////////////////////////////
                                ...
                                <tbody>
                                    <tr class="gradeA odd" role="row">
                                        <td class="sorting_1"><?php echo $row['sh_id']; ?></td>
                                        <td><?php echo $row['sh_name']; ?></td>
                                        <td><?php echo $row['date_created']; ?></td>         
                                     <td><a href="update_hub.php?prod_id=<?php echo $row['sh_id']; ?>" class="btn btn-primary btn-circle"><i class="fa fa-pencil"></i></a>&nbsp &nbsp 

                                   <a href="view_hubs_list.php?del_id=<?php echo $row['sh_id']; ?>" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i></a></td>
                                    </tr>
...
if(isset($_REQUEST['del_id'])){
    $del=$_GET['del_id'];
    $del_qry = "delete from hub where sh_id='$del'";
