...
<!--PAge for  viewing Seller and activating deactivating it  -->
...
////here to __ For displaying login approval list with similar area for adminand seller//////////////////
                               ...
                               $user=$_SESSION["email"];
                                                ...
                                                $ar=$row1["area"];
                                                    ...
                                                    $qry="select * from registration where isSeller='yes' AND reg_app='yes' and r_area='$ar' and user_email_status='verified'";
//////////////////////////// //here//////////////////////////////////////
                                ...
                                <tbody>
                                    <tr class="gradeA odd" role="row">
                                     ...
                                     <td><a href="view_saller.php?up_id=<?php echo $row['us_id']; ?>" class="btn btn-primary btn-circle">&nbsp Activate  &nbsp</a><br><br>

                                   <a href="view_saller.php?del_id=<?php echo $row['us_id']; ?>" class="btn btn-danger btn-circle">Deactivate</a></td>
                                    </tr>
...
if(isset($_REQUEST['del_id'])){
    ...
    $res= mysqli_query($con,$qry);
     $row=mysqli_fetch_array($res);
        ...
        $mail_body = "
        <p>Hi ".$row['uname'].",</p>
            <p>Your Seller account has been deactivated by Area admin.</p>
        ...
        <p>Please Open this link to login through your verified account- ".$base_url."login.php<p>Best Regards,<br />Team@E-NEIGHBORHOOD</p>         ";
           ...
           $mail1->SetFrom('eneighborhood14@gmail.com', "TEAM@E-NEIGHBORHOOD");
            ...
            if($mail1->Send())
                ...
                ?><script>window.location="view_saller.php";</script><?php
                    }
            else
            {
...
if(isset($_REQUEST['up_id'])){
    ...
    $res= mysqli_query($con,$qry);
     $row=mysqli_fetch_array($res);
        ...
        $mail_body = "
       <p>Hi ".$row['uname'].",</p>
            <p>Your Seller account has been activated by Area admin.</p>
        <p>Please Open this link to login through your verified account- ".$base_url."login.php<p>Best Regards,<br />Team@E-NEIGHBORHOOD</p>    ";
            $mail1 = new PHPMailer\PHPMailer\PHPMailer();
            $mail1->IsSMTP();
            $mail1->SMTPDebug  = false;
