...
////here to __ For displaying complain list of Seller to MASter Admin//////////////////
                                ...
                                $qry="select * from message where to_role='area admin' and to_mail='$mail' ";
//////////////////////////// //here//////////////////////////////////////
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="view_response_by.php?id=<?php echo $row['id'];?>  &email=<?php echo $mail; ?>"><center>SHOW</center></a> </td>
                                    </tr>
                        <?php
                      }
                      ?>
