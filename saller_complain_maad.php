...
////here to __ For displaying complain list of Seller to MASter Admin//////////////////
                                ...
                                $qry="select * from complain c join registration r on c.email=r.e_mail and c.isSeller=r.isSeller where c.isSeller='yes' and c.isAdmin='no'";
//////////////////////////// //here//////////////////////////////////////
                                ...
                                ?>
                                    <tr>
                                        <td class="sorting_1"><center><?php echo $row['cmp_id']; ?></center></td>
                                         <td><a href="view_profile_Seller_ma.php?id=<?php echo $row['us_id'];?>  &email=<?php echo $row['e_mail']; ?>"><center><?php echo $row['uname']; ?></center></a></td>
